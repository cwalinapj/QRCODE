...
RESOLVER_POLYGON_RPC_URL=https://rpc-amoy.polygon.technology
...
NEXT_PUBLIC_CHAIN_ID=${NEXT_PUBLIC_CHAIN_ID:-80002}
...
NEXT_PUBLIC_POLYGON_RPC_URL=${NEXT_PUBLIC_POLYGON_RPC_URL:-https://rpc-amoy.polygon.technology}
...
POLYGON_RPC_URL=${RESOLVER_POLYGON_RPC_URL:-https://rpc-amoy.polygon.technology}
